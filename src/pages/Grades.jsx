    ...
    <div>
      ...
      <div className="md:flex mx-10 md:w-[70%] mt-16 md:mx-auto justify-center">
        <div className="mx-auto">
          <h1 className="text-[32px] outfit-700">Your Ward's Grades</h1>
...
<div className="md:mx-auto w-[150px] relative">
          ...
          >
            {(ref) => (
              ...
              >
                ...
                {Object.keys(gradesData.semesters || {}).map((semester) => (
                  <div
                    key={semester}
      ...
      {/* Display data for the selected semester as a table */}

      {sem && gradesData.semesters && gradesData.semesters[sem] && (
        <div className="flex flex-col mt-12 md:px-16 overflow-x-auto w-screen mb-16 md:w-full px-10">
          <div className="md:p-1.5  inline-block align-middle md:w-full overflow-auto">
            <table className="table-auto border border-black min-w-full divide-y  divide-gray-200">
              ...
              <tbody className={`divide-y divide-gray-200 text-[14px]`}>
                {Object.entries(gradesData.semesters[sem]).map(
            ...
            <div className="outfit-400 mt-12">
              RA - Need to Reappear,&nbsp;&nbsp; AB - Absent,&nbsp;&nbsp; W -
              Withdrawal,&nbsp;&nbsp; SA - Shortage of Attendance,&nbsp;&nbsp; I
              - Incomplete
            </div>
          </div>
        </div>
